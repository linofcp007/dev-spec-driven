...
const MSG = {
  en: {
    ...
    brownfield: {
      ...
      root: "(root)",
      coverageUnmatched: (list) => `  ⚠ _Implements:_ entries that name no code file: ${list}`,
  ...
  pt: {
    ...
    brownfield: {
      ...
      coverageFolder: (folder, covered, files, pct) => `  ${folder.padEnd(24)} ${String(covered + "/" + files).padStart(9)}  ${pct}%`,
      root: "(raiz)",
      coverageUnmatched: (list) => `  ⚠ entradas _Implements:_ que não nomeiam nenhum ficheiro de código: ${list}`,
  ...
  es: {
    ...
    brownfield: {
      ...
      coverageFolder: (folder, covered, files, pct) => `  ${folder.padEnd(24)} ${String(covered + "/" + files).padStart(9)}  ${pct}%`,
      root: "(raíz)",
      coverageUnmatched: (list) => `  ⚠ entradas _Implements:_ que no nombran ningún fichero de código: ${list}`,
