...
const MSG = {
  en: {
    ...
    cliOutput: {
      ...
      scanEndpoints: (n, eg) => `  candidate endpoints: ${n}` + (eg ? ` (e.g. ${eg})` : ""),
      coverage: (pct, d, t) => `Spec coverage: ${pct}%  (${d}/${t} modules documented)`,
      undocumented: (list) => `  undocumented: ${list}`,
  ...
  pt: {
    ...
    cliOutput: {
      ...
      scanEndpoints: (n, eg) => `  endpoints candidatos: ${n}` + (eg ? ` (p. ex. ${eg})` : ""),
      coverage: (pct, d, t) => `Cobertura de specs: ${pct}%  (${d}/${t} módulos documentados)`,
      undocumented: (list) => `  sem documentação: ${list}`,
  ...
  es: {
    ...
    cliOutput: {
      ...
      scanEndpoints: (n, eg) => `  endpoints candidatos: ${n}` + (eg ? ` (p. ej. ${eg})` : ""),
      coverage: (pct, d, t) => `Cobertura de specs: ${pct}%  (${d}/${t} módulos documentados)`,
      undocumented: (list) => `  sin documentar: ${list}`,
