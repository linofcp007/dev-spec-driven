...
const MSG = {
  en: {
    ...
    deepTrace: {
      ...
      testsInCodeMissing: (list) => `made green by done tasks, but no test file names them: ${list} — put the T-ID in the test name (test("T-01 …"), def test_T01_…), in the file the plan's File column names`,
  ...
  pt: {
    ...
    deepTrace: {
      ...
      testsInCodeMissing: (list) => `postos a verde por tarefas feitas, mas nenhum ficheiro de teste os nomeia: ${list} — põe o T-ID no nome do teste (test("T-01 …"), def test_T01_…), no ficheiro que a coluna Ficheiro do plano indica`,
