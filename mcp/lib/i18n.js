...
const MSG = {
  en: {
    ...
    impact: {
      ...
      doctorChanged: (list, slug) => `changed after their approval: ${list} — see what the edit touches (spec_impact / dev-spec impact ${slug}), then re-approve`,
    ...
    metrics: {
      ...
      retroText: {
        ...
        sigRework: (ph, n) => `'${ph}' re-approved ${n} time(s)`,
  ...
  pt: {
    ...
    impact: {
      ...
      doctorChanged: (list, slug) => `alterado(s) após a aprovação: ${list} — vê o que a edição afeta (spec_impact / dev-spec impact ${slug}) e volta a aprovar`,
  ...
  es: {
    ...
    impact: {
      ...
      doctorChanged: (list, slug) => `modificado(s) tras su aprobación: ${list} — mira qué afecta la edición (spec_impact / dev-spec impact ${slug}) y vuelve a aprobar`,
