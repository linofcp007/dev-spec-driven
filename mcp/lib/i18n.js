...
const MSG = {
  en: {
    ...
    upgrade: {
      ...
      hookLine: (from) => `⬆ .specs/ was created with an older dev-spec (${from || "before 1.13"}) — run /spec-upgrade (dev-spec upgrade) to review what isn't implemented yet`,
      md: {
  ...
  pt: {
    ...
    upgrade: {
      ...
      hookLine: (from) => `⬆ .specs/ foi criado com um dev-spec mais antigo (${from || "anterior à 1.13"}) — corre /spec-upgrade (dev-spec upgrade) para rever o que ainda não está implementado`,
      md: {
        title: (proj) => `dev-spec upgrade — ${proj}`,
  ...
  es: {
    ...
    upgrade: {
      ...
      hookLine: (from) => `⬆ .specs/ se creó con un dev-spec más antiguo (${from || "anterior a la 1.13"}) — ejecuta /spec-upgrade (dev-spec upgrade) para revisar lo que aún no está implementado`,
      md: {
        title: (proj) => `dev-spec upgrade — ${proj}`,
